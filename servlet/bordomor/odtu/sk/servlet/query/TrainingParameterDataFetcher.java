...
@WebServlet("/query/get_training_parameter_data.jsp")
public class TrainingParameterDataFetcher extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
	
	public TrainingParameterDataFetcher() 
    {
        super();
    }
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try 
        {
			...
			{
				Branch teamBranch = new Branch(Integer.parseInt(branchIdStr));
				
				Team[] teams = Team.findByBranch(conn, teamBranch);
				Trainer[] trainers = Trainer.findByBranch(conn, teamBranch);
				...
				if(teams != null && locations != null)
				{
            		...
            		if(trainers != null)
	        		{
	            		...
	            		for(Trainer nextTrainer : trainers)
	            			trainersContainerEl.appendChild(nextTrainer.makeXMLElement(xml, false));
