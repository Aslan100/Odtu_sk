...
@WebServlet("/query/get_suitable_payment_schema_data_for_registration.jsp")
public class SuitablePaymentSchemasForRegistrationDataFetcher extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
	
	public SuitablePaymentSchemasForRegistrationDataFetcher() 
    {
        super();
    }
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try 
        {
			...
			PaymentSchema[] schemas = PaymentSchema.findByBranch(conn, reg.getRegistered().getPrimaryBranch());
			...
			if(schemas != null)
			{
        		...
        		Element schemaContainerEl = xml.createElement("payment_schemas");
        		
        		for(PaymentSchema nextSchema : schemas)
        			schemaContainerEl.appendChild(nextSchema.makeXMLElement(xml, true));
        		
        		parentEl.appendChild(schemaContainerEl);
