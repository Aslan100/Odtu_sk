...
@WebServlet("/query/get_training_data.jsp")
public class TrainingDataFetcher extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
	
	public TrainingDataFetcher() 
    {
        super();
    }
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try 
        {
			...
			{
				Training training = Training.findById(conn, Integer.parseInt(idStr));
				...
				if(training != null)
				{
	        		...
	        		trainingContainerEl.appendChild(training.makeXMLElement(xml, true));
