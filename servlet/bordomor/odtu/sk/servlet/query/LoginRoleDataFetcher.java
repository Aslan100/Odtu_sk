...
@WebServlet("/query/get_login_role_data.jsp")
public class LoginRoleDataFetcher extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
	
	public LoginRoleDataFetcher() 
    {
        super();
    }
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try 
        {
			...
			if(user == null || user.getRole() == null || !user.getRole().getRoleMod().canRead())
			...
			else
			{
	        	...
	        	LoginRole role = LoginRole.findById(conn, Integer.parseInt(roleId));
	        	
	        	if(role != null)
	        	{
	        		parentEl.appendChild(role.makeXMLElement(xml, false));
