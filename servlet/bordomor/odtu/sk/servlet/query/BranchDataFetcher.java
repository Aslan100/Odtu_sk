...
@WebServlet("/query/get_branch_data.jsp")
public class BranchDataFetcher extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
	
	public BranchDataFetcher() 
    {
        super();
    }
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try 
        {
			...
			if(user == null || user.getRole() == null || !user.getRole().getBranchMod().canRead())
			...
			else
			{
        		...
        		Branch[] branches = idStr == null ? Branch.findAll(conn) : new Branch[] { Branch.findById_IncludePromotions(conn, Integer.parseInt(idStr)) };
