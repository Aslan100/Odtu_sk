...
@WebServlet(Params.PORTAL_LOGIN_ROLES_URI)
public class LoginRolesController extends HttpServlet 
{
	private static final long serialVersionUID = 1L;

    public LoginRolesController() {}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			if(stok != null)
			{
				...
				{
					LoginRole[] roles = LoginRole.findAll(conn);
					...
					request.getRequestDispatcher("/view/login_roles.jsp").forward(request, response);
				}
			}
		}
		catch(Exception ex)
