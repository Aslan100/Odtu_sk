...
@WebServlet(Params.PORTAL_BRANCH_MANAGER_HOME_URI)
public class BranchManagerHomeController extends HttpServlet 
{
	private static final long serialVersionUID = 1L;

    public BranchManagerHomeController() {}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			else
			{
				...
				BranchManager loggedUser = BranchManager.findByStok(conn, stok);
				...
				else
				{
					...
					request.getRequestDispatcher("/view/branch_manager/home.jsp").forward(request, response);
				}
			}
		}
		catch(Exception ex)
