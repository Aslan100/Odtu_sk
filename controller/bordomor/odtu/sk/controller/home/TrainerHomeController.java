...
@WebServlet(Params.PORTAL_TRAINER_HOME_URI)
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			else
			{
				...
				Trainer loggedUser = Trainer.findByStok(conn, stok);
				...
				else
				{
					...
					request.getRequestDispatcher("/view/trainer/home.jsp").forward(request, response);
				}
			}
		}
		catch(Exception ex)
